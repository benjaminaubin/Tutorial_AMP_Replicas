...
class FoutGoutDgout_sign_sign(object):
    def __init__(self, K=1, y=0, omega=0, V=0, V_inv=0, parity=False):
        self.K = K
    ...
    def Zout_K2(self):
        ...
        # For symmetric outputs only 0 or 1 // -1,0,+1
        if self.parity:
            if y == 1:
                borne_s = self.borne_sup
                borne_i = omega2_tilde
                I1 = (quad(self.Zout_K2_annex, borne_i,
                           borne_s, args=(omega1_tilde, m, 1))[0])
                borne_s = omega2_tilde
                borne_i = self.borne_inf
                I2 = (quad(self.Zout_K2_annex, borne_i,
                           borne_s, args=(omega1_tilde, m, -1))[0])
                I = I1 + I2
            elif y == 0:
                borne_s = omega2_tilde
            ...
            if y == 1:
                borne_s = self.borne_sup
                borne_i = omega2_tilde
                I = (quad(self.Zout_K2_annex, borne_i,
                          borne_s, args=(omega1_tilde, m, y))[0])
            elif y == -1:
                borne_s = omega2_tilde
                borne_i = self.borne_inf
                I = (quad(self.Zout_K2_annex, borne_i,
    ...
    def dZout_K2(self):
        ...
        if self.parity:
            if y == 1:
                dZout_K2[0] = self.dZout_K2_annex(omega[0], omega[1], b, 'sup')[
                    0] - self.dZout_K2_annex(omega[0], omega[1], b, 'inf')[0]
                dZout_K2[1] = self.dZout_K2_annex(omega[1], omega[0], a, 'sup')[
                    0] - self.dZout_K2_annex(omega[1], omega[0], a, 'inf')[0]
            elif y == 0:
            ...
            if y == 1:
                dZout_K2[0] = self.dZout_K2_annex(
                    omega[0], omega[1], b, 'sup')[0]
                dZout_K2[1] = self.dZout_K2_annex(
                    omega[1], omega[0], a, 'sup')[0]

            elif y == -1:
                dZout_K2[0] = - \
                    self.dZout_K2_annex(omega[0], omega[1], b, 'inf')[0]
                dZout_K2[1] = - \
                    self.dZout_K2_annex(omega[1], omega[0], a, 'inf')[0]
    ...
    def dZout_K2_annex(self, w1, w2, x, borne_infinity):
        ...
        if borne_infinity == 'sup':
            ...
            I = quad(self.integrand_gaussian_integral,
                     borne_inf, borne_sup, args=())[0]
            res = N * I
        else:
    ...
    def ddZout_K2(self):
        ...
        if self.parity:
            ...
            if y == 1:
                ddZout_K2[0, 0] = self.ddZout_K2_annex_1(
                    omega[0], omega[1], b, c, d, 'borne_sup') - self.ddZout_K2_annex_1(omega[0], omega[1], b, c, d, 'borne_inf')
                ddZout_K2[0, 1] = self.ddZout_K2_annex_2(
                    omega[0], omega[1], b, c, d) + self.ddZout_K2_annex_2(omega[0], omega[1], b, c, d)
                ddZout_K2[1, 1] = self.ddZout_K2_annex_1(
                    omega[1], omega[0], a, c, d, 'borne_sup') - self.ddZout_K2_annex_1(omega[1], omega[0], a, c, d, 'borne_inf')
                ddZout_K2[1, 0] = self.ddZout_K2_annex_2(
                    omega[1], omega[0], a, c, d) + self.ddZout_K2_annex_2(omega[1], omega[0], a, c, d)
            elif y == 0:
                ddZout_K2[0, 0] = - self.ddZout_K2_annex_1(
                    omega[0], omega[1], b, c, d, 'borne_sup') + self.ddZout_K2_annex_1(omega[0], omega[1], b, c, d, 'borne_inf')
                ddZout_K2[0, 1] = - self.ddZout_K2_annex_2(
            ...
            if y == 1:
                ddZout_K2[0, 0] = self.ddZout_K2_annex_1(
                    omega[0], omega[1], b, c, d, 'borne_sup')
                ddZout_K2[0, 1] = self.ddZout_K2_annex_2(
                    omega[0], omega[1], b, c, d)
                ddZout_K2[1, 1] = self.ddZout_K2_annex_1(
                    omega[1], omega[0], a, c, d, 'borne_sup')
                ddZout_K2[1, 0] = self.ddZout_K2_annex_2(
                    omega[1], omega[0], a, c, d)
            elif y == -1:
                ddZout_K2[0, 0] = - \
                    self.ddZout_K2_annex_1(
                        omega[0], omega[1], b, c, d, 'borne_inf')
                ddZout_K2[0, 1] = self.ddZout_K2_annex_2(
                    omega[0], omega[1], b, c, d)
                ddZout_K2[1, 1] = - \
                    self.ddZout_K2_annex_1(
                        omega[1], omega[0], a, c, d, 'borne_inf')
                ddZout_K2[1, 0] = self.ddZout_K2_annex_2(
                    omega[1], omega[0], a, c, d)
